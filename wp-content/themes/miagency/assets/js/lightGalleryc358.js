...
(function($) {
    ...
    $.fn.lightGallery = function(options) {
        var defaults = {
            ...
            $gallery, $galleryCont, $slider, $slide, $prev, $next,$prev1, $next1, prevIndex, $thumb_cont, $thumb, windowWidth, interval, usingThumb = false,
            aTiming = false,
            aSpeed = false;
        ...
        var setUp = {
            ...
            structure: function() {
                $('#masonry-basic').append('<div id="lightGallery-outer" class="' + settings.addClass + '"><div id="lightGallery-Gallery"><div id="lightGallery-slider"></div><a id="lightGallery-close" class="close"></a></div></div>').addClass('lightGallery');
            ...
            buildThumbnail: function() {
                if (settings.thumbnail === true && $children.length > 1) {
					...
					$prev1.after('<a class="cLthumb"></a>');
					$prev1.parent().addClass('hasThumb');
            ...
            slideTo: function() {
                ...
                if (settings.controls === true && $children.length > 1) {
					...
					$gallery.append('<div id="popup-action"><a id="left-arrow"></a><a id="right-arrow"></a></div>');
                    $prev = $gallery.find('#lightGallery-prev');
                    $next = $gallery.find('#lightGallery-next');
					$prev1 = $gallery.find('#left-arrow');
                    $next1 = $gallery.find('#right-arrow');
